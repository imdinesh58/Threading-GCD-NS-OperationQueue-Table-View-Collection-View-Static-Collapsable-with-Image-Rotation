...
SWIFT_CLASS("_TtC17CoreDataSampleApp14CollectionCell")
...
SWIFT_CLASS("_TtC17CoreDataSampleApp19TableViewController")
@interface TableViewController : UITableViewController
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified btnView;
- (void)viewDidLoad;
...
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull test2 SWIFT_DEPRECATED_OBJC("Swift property 'ViewController2.test2' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull test3 SWIFT_DEPRECATED_OBJC("Swift property 'ViewController2.test3' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull test4 SWIFT_DEPRECATED_OBJC("Swift property 'ViewController2.test4' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (NSDictionary<NSString *, id> * _Nullable)convertStringToDictionaryWithText:(NSString * _Nonnull)text SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'ViewController2.convertStringToDictionary(text:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
- (NSDictionary<NSString *, id> * _Nullable)convertStringToDictionary2WithText:(NSString * _Nonnull)text SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'ViewController2.convertStringToDictionary2(text:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
...
SWIFT_CLASS("_TtC17CoreDataSampleApp13tableviewCell")
